...
(function(window, document, undefined) {
    ...
    var defaults = {
        messages: {
            ...
            alpha: 'El campo "%s" debe tener unicamente caracteres alfabéticos.',
            alpha_numeric: 'El campo "%s" debe tener unicamente caracteres alfanuméricos.',
            alpha_dash: 'El campo "%s" debe tener unicamente caracteres alfanuméricos, guiones bajos o barras diagonales.',
            numeric: 'El campo "%s" debe tener unicamente números.',
            ...
            valid_ip: 'El campo "%s" debe ser una IP válida.',
